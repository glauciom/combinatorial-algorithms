...
public class SerialComposition {
	...
	public static void main(String[] args) {
		SerialComposition test = new SerialComposition(7,5);
		//for(int i = 1; i <= test.getNumberOfCompositions(); i++) {
		 Date r = new Date();
		 long t0 = r.getTime();
		 test.serialComposition(283);
		 System.out.println(283 + "-> " +test);
	//	}
	    /*r = new Date();
